...
public partial class PassiveSkill
{
    ...
    public int? CutinType { get; set; } = null;
    public int? TrigerType { get; set; } = null;
    public float? TrigerPar { get; set; } = null;
    public float? TrigerValue { get; set; } = null;
    public int? TrigerCount { get; set; } = null;
